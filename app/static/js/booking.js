document.addEventListener("DOMContentLoaded", () => {
  ...
  const messages = {
    it: {
      selectDates: { title: "Attenzione ✨", message: "Per favore seleziona sia la data di check-in che quella di check-out per continuare." },
      invalidRange: { title: "Data non valida 🚫", message: "La data di check-out deve essere successiva alla data di check-in." }
    },
    en: {
      selectDates: { title: "Heads up ✨", message: "Please select both your check-in and check-out dates to proceed." },
      invalidRange: { title: "Invalid dates 🚫", message: "Your check-out date must come after your check-in date." }
    },
    fr: {
      selectDates: { title: "Attention ✨", message: "Veuillez sélectionner à la fois la date d’arrivée et de départ pour continuer." },
      invalidRange: { title: "Dates invalides 🚫", message: "La date de départ doit être postérieure à la date d’arrivée." }
    },
    de: {
      selectDates: { title: "Hinweis ✨", message: "Bitte wählen Sie sowohl Check-in- als auch Check-out-Datum, um fortzufahren." },
      invalidRange: { title: "Ungültiges Datum 🚫", message: "Das Check-out-Datum muss nach dem Check-in-Datum liegen." }
    }
  };
