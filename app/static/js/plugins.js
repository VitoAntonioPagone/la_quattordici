...
!(function (t, e) {
  ...
  return (function () {
    ...
    var t = {
        d: function (e, n) {
          for (var a in n)
            t.o(n, a) && !t.o(e, a) && Object.defineProperty(e, a, { enumerable: !0, get: n[a] })
        },
        o: function (t, e) {
    ...
    function n() {
      ...
      ;((this.addOnSelectEvent = function (t) {
        for (var e = t.querySelectorAll('td.selectable'), n = 0, a = e.length; n < a; n++)
        ...
        (this.checkDateTimeConsistency = function () {
          ...
          if (
            ...
            'start' == o
              ? e + this.min_range >= a &&
                (e + this.min_range >= n && this.start_date.setTime(n - this.min_range),
                this.end_date.setTime(this.start_date.getTime() + this.min_range),
                this.printDateAndTime(this.end_container, this.end_date))
              : (a - this.min_range <= e &&
                  (a - this.min_range <= t && this.end_date.setTime(t + this.min_range),
        ...
        (this.get_Dates = function () {
          var t = new Date().setHours(0, 0, 0, 0),
            ...
            i = null
          return (
            this.end_date && (i = new Date(this.end_date).setHours(0, 0, 0, 0)),
            { _today: t, _start_date: e, _first_date: n, _last_date: a, _end_date: i }
          )
        }),
        (this.getDayClassName = function (t, e, n) {
          ...
          return (
            ...
            a == n._today && (i += 'today '),
            a == n._start_date &&
              ((i += 'start-day '), (i += 'start' == o ? 'active ' : 'inactive ')),
            this.end_date &&
              (a > n._start_date && a < n._end_date && (i += ' range'),
              a == n._end_date &&
                ((i += ' end-day '), (i += 'end' == o ? 'active ' : 'inactive '))),
            i
          )
        }),
        (this.getHourClassName = function (t, e) {
          ...
          return (
            r < this.first_date || r > this.last_date
              ? (c += 'disabled')
              : ((c += 'selectable'), (c += n == t ? ' time-selected ' + o : '')),
            c
          )
        }),
        (this.getHTML = function (t, e, n) {
          ...
          var d = this[t + '_container'].querySelector('input.date_output')
            ? ''
            : '<input type="hidden" name="'.concat(s, '_value" class="date_output" value="">')
          if ('datetime' === e)
            a =
        ...
        (this.onClickOutside = function (e) {
          ...
          do {
            if (
              a.matches('#'.concat(n.parentElement.id, '.datetime-container')) ||
        ...
        (this.onOpenPicker = function (e) {
          ...
          if (
            ((d +=
              null !== (n = t.end_container) && void 0 !== n && n.id
            ...
            c.classList.contains('start')
              ? ((a = t.start_picker), (i = t.end_picker), (s = t.start_date), (o = 'start'))
              : ((a = t.end_picker), (i = t.start_picker), (s = t.end_date), (o = 'end')),
              ...
              (function (t) {
                ...
                e > 0 &&
                  ('scrollBehavior' in document.documentElement.style
                    ? window.scrollBy({ top: e, left: 0, behavior: 'smooth' })
                    : window.scrollBy(0, e))
              })(a))
        ...
        (this.printDateAndTime = function (t, e) {
          ...
          if (h) {
            ...
            ;((_.textContent = ('0' + e.getHours()).slice(-2)),
              (p.textContent = ':'.concat(('0' + e.getMinutes()).slice(-2))))
          }
          var m,
            v,
            f,
        ...
        (this.roundMinutes = function (t) {
          ...
          t.forEach(function (t) {
            ...
            ;(60 == n && ((n = 0), 24 == (a += 1) && ((a = 0), t.setDate(t.getDate() + 1))),
              t.setHours(a, n))
          })
        }),
        ...
        (this.selectHour = function (t) {
          ...
          for (var e = document.querySelectorAll('td.selectable'), n = 0, a = e.length; n < a; n++)
            e[n].className = this.getHourClassName(e[n].textContent, t.date)
          ;(this.printDateAndTime(t.container, t.date), this.closePicker(t.picker, t.btn, 500))
        }),
        (this.setEndPickerProps = function (t, e) {
          var n = document.getElementById(t)
          if (null == n || 'DIV' != n.nodeName)
            throw new Error('Does div#'.concat(t, ' exist? Please, check your HTML code'))
        ...
        (this.showAlternativeTimePicker = function (t, e) {
          for (
            ...
            if ((r.setHours(h), !(r < this.first_date || r > this.last_date))) {
              ...
              ;(_ && (a = h),
                (l += '<option value="'.concat(u, '" ').concat(_, '>').concat(u, '</option>')))
            }
          l += '</select>'
          var p,
            m,
          ...
          ;((v += c()),
            ...
            'start' == o
              ? ((p = this.start_container), (m = this.start_time_btn))
              : ((p = this.end_container), (m = this.end_time_btn)))
        ...
        (this.showDatePicker = function (t, e) {
          for (
            ...
            ((v = y - (f - 1)),
              ...
              (r += '<td class="prev-month '.concat(a, '">').concat(v, '</td>')),
              f--)
          for (v = 1; v <= l[o]; )
            (u > 6 && ((u = 0), (r += '</tr><tr>')),
              (a = this.getDayClassName(v, h, m)),
              (r += '<td class="'.concat(a, '">').concat(v, '</td>')),
              u++,
              v++)
          for (v = 1; u <= 6; u++, v++)
            ((a = this.getDayClassName(v, p, m)),
              (r += '<td class="next-month '.concat(a, '">').concat(v, '</td>')))
          ;((t.innerHTML =
            ...
            for (o += '<tr>', r *= 1; r < 6 * c; r++)
              i[r]
                ? ('',
                  ...
                  (o += '<td class="'.concat(a, '">').concat(i[r], '</td>')))
                : (o += '<td class="white-background disabled"></td>')
            o += '</tr>'
          }
          ;((t.innerHTML = '<table class="time">\n      <tr>\n        <th colspan="7">\n          '
            .concat(this.i18n[n[d(e)] + '_'], '\n          ')
    ...
    function a(t) {
      ...
      ;(n.call(this),
        ...
        (this.date_output = e.date_output ? e.date_output : 'short_ISO'))
    ...
    function s(t, e) {
      ...
      ;(n.call(this),
        ...
        (this.date_output = a.date_output ? a.date_output : 'short_ISO'),
